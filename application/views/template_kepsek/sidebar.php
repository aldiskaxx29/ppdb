...
<div class="main-sidebar">
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li>
        <a class="nav-link" href="<?= base_url('kepsek/laporanpendaftaran')  ?>"><i class="fas fa-users"></i> <span>Laporan Pendaftaran</span></a>
      </li>
      <li>
        <a class="nav-link" href="<?= base_url('kepsek/laporanpembayaran')  ?>"><i class="fas fa-dollar-sign"></i> <span>Laporan Pembayaran</span></a>
      </li>
