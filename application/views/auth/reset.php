                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="" class="needs-validation">
                                <div class="form-group">
                                    ...
                                    <input id="password" type="password" class="form-control" name="password" tabindex="1" autofocus autocomplete="off">
                                    <?= form_error('password', '<small class="text-danger">', '</small>') ?>
                                </div>
                                <div class="form-group">
                                    <label for="konfirm_password">Konfirmasi Password</label>
                                    <input id="konfirm_password" type="password" class="form-control" name="konfirm_password" tabindex="1" autofocus autocomplete="off">
                                </div>
